...
public class FileUtils extends org.apache.commons.io.FileUtils {
	...
	public static boolean copyFileCover(String srcFileName, String descFileName, boolean coverlay) {
		...
		try {
			...
			log.debug("复制文件失败：" + LoggerUtil.getTrace(e));
			return false;
		} finally {
	...
	public static void zipFiles(String srcDirName, String fileName, String descFileName) {
		...
		try {
			...
			log.debug("文件压缩失败：" + LoggerUtil.getTrace(e));
			e.printStackTrace();
		}
	}
	...
	public static boolean unZipFiles(String zipFileName, String descFileName) {
		...
		try {
			...
			log.debug("文件解压失败：" + LoggerUtil.getTrace(e));
			return false;
		}
	}
	...
	/**
	 * 获取inputFilePath的文件名，如："e:/test.pptx"的文件名为："test"<br>
	 * 
	 * @param inputFilePath
	 * @return
	 */
	public static String getPrefixName(String inputFilePath) {
	 ...
	 * @return
	 */
	public static String getSuffixName(String inputFilePath) {
