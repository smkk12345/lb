...
//	public static final String OSS_MEDIA = "http://longbei3-mp4-out.oss-cn-shanghai.aliyuncs.com/";
	...
	public static final int LIVE_START = 30; //设置直播开始几分钟可进入
	public static final int LIVE_END = 30; //设置直播结束可延迟分钟
	...
	public static final int STATUS_SYS_120 = -120;
	...
	public static final int STATUS_SYS_402 = -402;
	...
	public static final String RTNINFO_SYS_120 = "该昵称已受保护";
	...
	public static final String RTNINFO_SYS_402 = "每日点赞达到上限";
...
//	public static final String  MSG_QUITRANK_QUIT_MODEL = "您在龙榜'n'中的进步已下榜!";      //下榜
	...
	public static final String  MSG_CLASSROOM_MODEL = "很遗憾,您已被请出教室《n》,查看更多帮助"; //教室
...
//	public static final String JPUSH_TAG_COUNT_1303 = "1303";//创建的龙榜／教室／圈子被选为推荐
	...
	public static final String JPUSH_TAG_COUNT_1306 = "1306";//老师认证通过
	...
	public static final String JPUSH_TAG_COUNT_1401 = "1401";//创建教室权限被恢复
	//14开头 好友对话  前端推送
