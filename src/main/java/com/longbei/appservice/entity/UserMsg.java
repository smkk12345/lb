...
public class UserMsg implements Serializable {
	...
	private String mtype; 	//mtype 0 系统消息(msgtype  18:升龙级   19：十全十美升级   20:榜关注开榜通知    21：榜关注结榜通知
												//22:加入的榜结榜未获奖   24：订单已发货
												//25:订单发货N天后自动确认收货    26：实名认证审核结果
												//27:工作认证审核结果      28：学历认证审核结果
												//29：被PC选为热门话题    30：被选为达人(选为,取消龙杯达人)   31：微进步被推荐
												//32：创建的龙榜/教室/圈子被选中推荐---暂不使用    34.加入的榜获奖通知---中奖消息 
												//35.群主收到的加群申请    40：订单已取消 41 榜中进步下榜   
												// 42.榜单公告更新   43:后台反馈回复消息    45:榜中删除成员进步 
												// 47: 龙榜达人(选为,取消榜单达人)  53：被授予龙杯名人认证 
												// 55：转让群主权限 56:被授予龙杯Star认证 57:教室关闭 58:教室课程更新
												// 59:删除教室成员进步  
												// 63：教室收益提现到钱包 64： 教室提现到银行卡，支付宝 ,钱包	
												// 66: 学员退出教室  67:学员加入教室   72:直播还有十分钟开始(关注)   )
							//1 对话消息(msgtype 0 聊天 1 评论 2 点赞 3  送花 4 送钻石  5:关注---粉丝    62: 邀请注册进步币奖励    68:批复被评论 )
							...
							//					61:教室收到新的提问  
							//                  65:老师认证审核结果(成功)  69:老师认证审核结果(失败)
							//                  70: 创建新教室权限被禁用  71：创建新教室权限被恢复  72:直播还有十分钟开始(加入) ) 73:私密教室邀请

	private String msgtype; //0 聊天 1 评论 2 点赞 3  送花 4 送钻石  5:关注---粉丝 等等
							//10:邀请   11:申请加入特定圈子   12:老师批复作业  13:老师回复提问
							//15:获奖   16:剔除   17:加入龙榜/群组的申请审核结果
							// 18:升龙级   19：十全十美升级   20:榜关注开榜通知    21：榜关注结榜通知
							//22:加入的榜结榜未获奖    24：订单已发货
							//25:订单发货N天后自动确认收货    26：实名认证审核结果
							//27:工作认证审核结果      28：学历认证审核结果
							//29：被PC选为热门话题    30：被选为达人(选为,取消龙杯达人)   31：微进步被推荐 
							//32：创建的龙榜/教室/圈子被选中推荐---暂不使用   34.加入的榜获奖通知 35.群主收到的加群申请
	  						//40：订单已取消 41 榜中进步下榜 42.榜单公告更新      43:后台反馈回复消息  44: 榜中成员下榜
							//  45:榜中删除成员进步 46 榜关闭  47: 龙榜达人(选为,取消榜单达人)  48:入群被拒绝     49:发布榜单审核未通过   50:个人定制榜邀请
							// 51.入榜审核通过 52.入榜审核不通过 53：被授予龙杯名人认证 54: 剔除教室成员
							// 55：转让群主权限 56:被授予龙杯Star认证
							// 57:教室关闭       58:教室课程更新   59:删除教室成员进步
							// 60:教室发布新公告  61:教室收到新的提问  62: 邀请注册进步币奖励
							// 63：教室收益提现到钱包 64:教室提现到银行卡，支付宝 钱包    65:老师认证审核结果(成功) 
							// 66: 学员退出教室   67:学员加入教室   68:批复被评论   69:老师认证审核结果(失败)
							// 70: 创建新教室权限被禁用  71：创建新教室权限被恢复   72:直播还有十分钟开始(关注，加入) 73:私密教室邀请
	...
	private String gtype; //gtype 0:零散 1:目标中 2:榜中微进步  3:圈子中微进步 4.教室中微进步  5:龙群  6:龙级  7:订单  8:认证 9：系统 
									//10：榜中  11 圈子中  12 教室中  13:教室批复作业评论   14:反馈 15 关注  16 邀请
