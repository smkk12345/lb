...
//	private UserRelationService userRelationService;
	 ...
	 * 					11：教室收益   12：教室收费  13,教室礼物消耗 14，教室被送礼物增加
	 * 				    15：教室收益提现
	 *
...
//				userInfoMapper.updateTotalmoneyByUserid(userInfo.getUserid(), allnum);
				userInfoMapper.updateMoneyAndFlowerByUserid(userInfo.getUserid(), number, 0);
				reseResp.initCodeAndDesp(Constant.STATUS_SYS_00, Constant.RTNINFO_SYS_00);
			}
		} catch (Exception e) {
			logger.error("insertPublic userid = {}, origin = {}, number = {}, friendid = {}",
