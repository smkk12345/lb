...
public interface UserPlDetailMapper {
     ...
     */
    List<UserPlDetail> selectUnlightenListByUserId(@Param("userid") long userid,@Param("ptypes") String[] ptypes,@Param("startNum") Integer startNum,@Param("pageSize")Integer pageSize);
